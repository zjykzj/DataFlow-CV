#!/usr/bin/env python3
"""Segmentation evaluation demo — mAP (default) or P/R/F1 (--prf1)."""
...
GT_FILE = EVAL_DATA / "gt_coco_segm.json"
DT_FILE = EVAL_DATA / "dt_coco_segm.json"
...
def main():
    ...
    log_config = LogConfig(name="eval_segmentation", verbose=args.verbose)
