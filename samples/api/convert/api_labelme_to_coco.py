...
def demo_error_handling():
    ...
    try:
        ...
        try:
            result = dataflow.labelme_to_coco(test_paths["nonexistent_path"],
        ...
        try:
            result = dataflow.labelme_to_coco(os.path.join(test_paths["temp_dir"], "labels"),
        ...
        try:
            ...
            try:
                result = dataflow.labelme_to_coco(label_dir, classes_file,
                                                 os.path.join(test_paths["temp_dir"], "output.json"))
                print(f"   ❌ Should have raised an error")
