...
| 6 | [`spec_cli.md`](spec_cli.md) | **CLI module** — Click-based command structure, 11 subcommands (6 convert + 3 visualize + 2 evaluate), option decorators, exception hierarchy, exit code system |
