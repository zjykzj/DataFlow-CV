...
- **New to the codebase?** Start with `spec_label.md` (foundation), then `spec_logging.md` (infrastructure), then `spec_convert.md`, then `spec_visualize.md`, then `spec_evaluate.md`, then `spec_cli.md`.
