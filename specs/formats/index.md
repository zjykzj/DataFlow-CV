...
spec_coco_format.md    ──▶      spec_analyse.md
spec_labelme_format.md          spec_convert.md
spec_conversion.md              spec_visualize.md
                                spec_evaluate.md
                                spec_cli.md
...
The Formats layer defines the data contract. The [Modules layer](../modules/index.md) defines the software components that read, write, analyse, convert, visualize, and evaluate that data.
