...
class TestCocoToYoloConverter(unittest.TestCase):
    ...
    def test_successful_conversion(self):
        ...
        self.assertEqual(result.get("coco_json_path"), self.coco_json_path)
        ...
        label_file = os.path.join(labels_dir, "test_image.txt")
    ...
    def test_coco_json_without_categories(self):
        ...
        self.assertEqual(result.get("total_categories"), 0)
    ...
    def test_conversion_statistics(self):
        ...
        # Check statistics
        self.assertEqual(result.get("total_images"), 2)
        self.assertEqual(result.get("total_annotations"), 2)
        self.assertEqual(result.get("total_categories"), 2)
        self.assertEqual(result.get("images_processed"), 2)
        self.assertGreaterEqual(result.get("images_with_annotations"), 1)
