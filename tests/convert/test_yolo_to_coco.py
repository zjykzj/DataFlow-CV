...
class TestYoloToCocoConverter(unittest.TestCase):
    ...
    def test_successful_conversion(self):
        ...
        self.assertEqual(result.get("yolo_labels_dir"), self.labels_dir)
        self.assertEqual(result.get("yolo_class_path"), self.classes_file)
    ...
    def test_images_without_labels(self):
        ...
        # Should have 3 images (2 original + 1 extra)
        self.assertEqual(len(coco_data["images"]), 3)
    ...
    def test_conversion_statistics(self):
        ...
        # Check statistics
        self.assertEqual(result.get("total_classes"), 3)
        self.assertEqual(result.get("images_processed"), 2)
        self.assertEqual(result.get("annotations_processed"), 3)
        self.assertEqual(result.get("images_with_annotations"), 2)
        self.assertGreaterEqual(result.get("total_label_files"), 2)
